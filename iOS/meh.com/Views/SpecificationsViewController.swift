...
//  meh.com
//
//  Created by Kirin Patel on 9/4/18.
...
class SpecificationsViewController: UIViewController {
    ...
    var specifications: String! {
        didSet {
            let md = SwiftyMarkdown(string: specifications.replacingOccurrences(of: "\\", with: ""))
    ...
    @objc func handleClose() {
        Analytics.logEvent("closeSpecifications", parameters: [:])
